...
public class HomePieceOfFurniture3D extends Object3DBranch {
  ...
  private Node getModelBox(Color color) {
    ...
    material.setDiffuseColor(new Color3f(color.getRed(),color.getGreen(),color.getBlue()));
    material.setAmbientColor(new Color3f(color.darker().getRed(),color.darker().getGreen(),color.darker().getBlue()));
