...
public class HomeController3D implements Controller {
  ...
  //PJPJPJ methods below for mouse over handler
  /**
  ...
  /**
   * Controls the modification of the selected DimensionLines.
   */
  ...
  public void modifySelectedPolylines() {
    if (!Home.getPolylinesSubList(this.home.getSelectedItems()).isEmpty()) {
      new PolylineController(this.home, this.preferences, this.viewFactory, this.contentManager,
          this.undoSupport).displayView(getView());
    }
  }
}
